...
} from "./chunk-5TPHOXPI.js";
import {
  memoTheme_default,
  useDefaultProps
} from "./chunk-SFFIKSRZ.js";
import {
  composeClasses,
...
var CardActionArea = React5.forwardRef(function CardActionArea2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCardActionArea"
  });
  ...
  return (0, import_jsx_runtime4.jsxs)(CardActionAreaRoot, {
    className: clsx_default(classes.root, className),
    focusVisibleClassName: clsx_default(focusVisibleClassName, classes.focusVisible),
    ref,
    ownerState,
    ...other,
    children: [children, (0, import_jsx_runtime4.jsx)(CardActionAreaFocusHighlight, {
